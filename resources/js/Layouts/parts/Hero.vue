<template>
  <section class="text-gray-600 body-font">
    <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
      <img class="md:w-8/6 w-full max-h-32 mb-10 object-cover object-center rounded" alt="hero" src="https://dummyimage.com/1024x768">
      <div class="text-center lg:w-2/3 w-full">
        <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">{{title}}</h1>
        <p class="mb-8 leading-relaxed"><slot></slot></p>
